...
characters=[['bit man v.8',[blue,darkBlue,red,darkRed,orenge],[2,1,'hi',.002,10,240,[green,darkGreen],.5,.3,10],[3,19,7,48,.8,.2,10,50,32],[2,.6,.6,15,72,.35,.1,.32,.15,65],'TBD','TBD',5,1.25,.5],
            ['quin',[grey,grey,blue,darkBlue,black],[1,1.5,'hi',.005,7,150,[blue,darkBlue],1,.5,17],[2,25,5,52,1.2,.5,15,35,53],[3,1.2,.18,20,80,.25,.6,.24,.7],'TBD','TBD',4,1.875,.7],'TBD','TBD','TBD']
t=0
